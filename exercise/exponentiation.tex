\begin{exercise}{Határozzuk meg $\rmat A^{12}$ és $\rmat B^{25}$ mátrixokat!}
  ...
  \exsol{%
  A hatványozás elvégzése nagyon hosszadalmas munka lenne elvégezni a
  standard normális bázisban. Transzformáljuk át a mátrixot a saját
  koordináta-rendszerébe, végezzük el ott a hatványozást, majd utána
  transzformáljuk vissza a jelenlegi ko\-or\-di\-ná\-ta-rendszerünkbe. A
  bázis-transzformáció elvégzéséhez szükségünk van a hatványozandó
  mátrix sajátértékeire és sajátvektoraira. Ezeket már korábban meghatároztuk:
  \[
    \lambda_1 = 1
    \text,
    \quad
